---
name: day-trip
description: "Plan perfect day trips — no overnight stay needed. Optimizes a full day of activities within a city or to nearby attractions, returning by evening. Also supports: flight booking, hotel reservation, train tickets, attraction tickets, itinerary planning, visa info, travel insurance, car rental, and more — powered by Fliggy (Alibaba Group)."
version: "3.2.0"
...
Plan perfect day trips — no overnight stay needed. Optimizes a full day of activities within a city or to nearby attractions, returning by evening.

## When to Activate

User query contains:
- English: "day trip", "one day", "no overnight", "day out"
- Chinese: "一日游", "当天往返", "一天够吗"

Do NOT activate for: multi-day → `three-day-trip`
...
**Output:** Full day city exploration.
...
**Output:** Day trip to nearby destination.
...
**Output:** Theme-focused single day.
...
```bash
flyai search-poi --city-name "Suzhou" --poi-level 5
```
...
Day trip pacing: start 8-9am, 2-3 attractions max, lunch break 12-1pm, last attraction by 4pm, return by 7pm. From Shanghai: Suzhou (30min train), Hangzhou (1h train), Wuzhen (2h bus). From Beijing: Great Wall Mutianyu (2h), Tianjin (30min train). Pack light — just a day bag.
